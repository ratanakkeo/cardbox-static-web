<?php
/**
 * Legacy Book Club Theme Customizer
 *
...
if ( ! function_exists( 'legacy_book_club_customize_register' ) ) :
function legacy_book_club_customize_register( $wp_customize ) {
    ...
    $wp_customize->register_control_type( 'Legacy_Book_Club_Toggle_Control' );
    ...
    if ( isset( $wp_customize->selective_refresh ) ) {
        $wp_customize->selective_refresh->add_partial( 'blogname', array(
            ...
            'render_callback' => 'legacy_book_club_site_title_callback',
            'fallback_refresh'    => false,
        ) );
        $wp_customize->selective_refresh->add_partial( 'blogdescription', array(
            'selector'        => '.site-description',
            'render_callback' => 'legacy_book_club_site_description_callback',
            'fallback_refresh'    => false, 
        ) );
    }
    ...
    $wp_customize->add_setting( 
        'legacy_book_club_display_site_title_tagline', 
        array(
            'default'           => true,
            'type'              => 'theme_mod',
    ...
    $wp_customize->add_control( 
        new Legacy_Book_Club_Toggle_Control( $wp_customize, 'legacy_book_club_display_site_title_tagline', 
        array(
            'label'       => esc_html__( 'Display Site Title and Tagline', 'legacy-book-club' ),
            'section'     => 'title_tagline',
            'type'        => 'legacy-book-club-toggle',
            'settings'    => 'legacy_book_club_display_site_title_tagline',
        ) 
    ));
    
}
endif;
add_action( 'customize_register', 'legacy_book_club_customize_register' );
 ...
 */
if ( ! function_exists( 'legacy_book_club_enqueue_customizer_stylesheets' ) ) :
function legacy_book_club_enqueue_customizer_stylesheets() {
    wp_register_style( 'legacy-book-club-customizer-css', get_template_directory_uri() . '/inc/customizer/assets/css/customizer.css', array(), '1.0.9', 'all' );
    wp_enqueue_style( 'legacy-book-club-customizer-css' );
}
endif;
add_action( 'customize_controls_print_styles', 'legacy_book_club_enqueue_customizer_stylesheets' );